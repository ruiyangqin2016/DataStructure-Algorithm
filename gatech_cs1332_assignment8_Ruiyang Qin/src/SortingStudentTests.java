...
public class SortingStudentTests {
    ...
    private TeachingAssistant[] arr;
    private ComparatorPlus<TeachingAssistant> comp;
    private static final int TIMEOUT = 200;

    @Before
    public void setUp() {
        arr = new TeachingAssistant[8];

        tas = new TeachingAssistant[10];
        tas[0] = new TeachingAssistant("Adrianna", 7);
        tas[1] = new TeachingAssistant("Chad", 30);
        tas[2] = new TeachingAssistant("Jackie", 25);
        tas[3] = new TeachingAssistant("Miguel", 19);
        tas[4] = new TeachingAssistant("Ashley", 60);
        tas[5] = new TeachingAssistant("Scott", 22);
        tas[6] = new TeachingAssistant("Tim", 38);
        tas[7] = new TeachingAssistant("Joey", 4);
        tas[8] = new TeachingAssistant("Raymond", 80);
        tas[9] = new TeachingAssistant("Bartosz", 2);
